		...
		<div class="container">
			<div class="row">
				...
				<div class="span9" id="mainCol">
					...
					<hr class="soft">
					<h4>1. Hình Thức Mua Hàng Online Tại CT Computer Shop</h4>
					<p>- Bạn đăt hàng trên Web → Nhân viên CT Computer Shop sẽ gọi
						điện thoại xác nhận đơn hàng của bạn → Giao hàng và Thu tiền tận
						nơi trên toàn quốc.</p>
					<br>

					<h4>2. Thời gian mở cửa tại các Shop của CT Computer Shop</h4>
					<p>- Các shop của CT Computer Shop mở cửa từ 8h tới 21h tất cả các
						ngày, kể cả thứ 7 và Chủ Nhật</p>
					<br>

					<h4>3. Có phải đặt hàng online trên trang website trước khi
						đến các Shop của CT Computer Shop hay không?</h4>
					<p>- CT Computer Shop có đầy đủ các mặt hàng mà trên website bán,
						bạn có thể tới trực tiếp mua hàng không cần đặt trước trên website</p>
					<br>

					<h4>4. Mua tại các shop của CT Computer Shop có nhận được tiền
						tích lũy không ?</h4>
					<p>- Tiền tích lũy chỉ áp dụng cho các thành viên của Website
						CT Computer Shop mua hàng online bạn nhé.</p>
					<br>

					<h4>5. Giá các sản phẩm tại các shop CT Computer Shop có giống
						giá trên Website CT Computer Shop không ?</h4>
					<p>- Tất cả sản phẩm trên Website CT Computer Shop bán giống giá
						với tất cả các hệ thống Shop của CT Computer Shop.</p>
					<br>

					<h4>6. Địa chỉ các Shop của CT Computer Shop xem ở đâu ?</h4>
					<p>- Bạn bấm phần “Liên Hệ” trên đầu trang website để coi địa
						chỉ và số điện thoại các của các Shop của CT Computer Shop.</p>
					<br>

					<h4>7. Xem phí vận chuyển như thế nào ?</h4>
					<p>- Tất cả các mặt hàng tại CT Computer Shop có dịch vụ giao hàng
					...
					<h4>9. Hàng của CT Computer Shop đổi có giao hàng tận nơi không?</h4>
					...
					<p>- Ở Hà Nội nhân viên CT Computer Shop giao hàng tận nơi.</p>
					<br>
					...
					<p>- Bạn trở thành khách hàng thân thiện sẽ được tham gia miễn
						phí tất cả các chương trình giảm giá của CT Computer SHop và còn được
					...
					<h4>12. Hình thức đổi trả hàng như thế nào, nếu Sản Phẩm bị
						lỗi do CT Computer Shop hoặc nhà sản xuất ?</h4>
					...
					<p>- Một số mặt hàng bên CT Computer Shop giao màu ngẫu nhiên, bên
						CT Computer Shop có nói rõ trong phần chi tiết sản phẩm.</p>
					<br>

					<h4>15. Sản phẩm bên ngoài có giống trong hình trên Website
						không?</h4>
					<p>- Sản phẩm được CT Computer Shop được đặt riêng với tiêu chí
